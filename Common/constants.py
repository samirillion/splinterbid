...
class SUIT(object):
    ...
    STRING_TO_SUIT = {key: val for val, key in STRING_REPR.iteritems()}
...
class VALUE(object):
    ...
    STRING_TO_VALUE = {key: val for val, key in STRING_REPR.iteritems()}
...
# This will need to be specified NOT as a constant, someday
